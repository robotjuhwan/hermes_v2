...
def test_load_runtime_sessions_uses_safe_no_order_defaults_on_invalid_file(tmp_path) -> None:
    path = tmp_path / "sessions.json"
    ...
    assert source.startswith("safe_default_no_orders")
    assert sessions
